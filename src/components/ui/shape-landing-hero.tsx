...
function HeroGeometricBackdrop({ className }: { className?: string }) {
  return (
    <div className={cn('absolute inset-0 overflow-hidden bg-[#030303]', className)} aria-hidden="true">
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/[0.08] via-transparent to-rose-500/[0.05] blur-3xl" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center md:px-6">
        <div className="mx-auto max-w-3xl">
          <motion.div
            ...
            className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 backdrop-blur-sm md:mb-12"
          >
          ...
          >
            <div className="group relative inline-block overflow-hidden rounded-2xl bg-gradient-to-b from-black/10 to-white/10 p-px shadow-lg transition-shadow duration-300 hover:shadow-xl dark:from-white/10 dark:to-black/10">
              <Button
                variant="ghost"
                className="rounded-[1.15rem] border border-white/10 bg-white/95 px-8 py-6 text-lg font-semibold text-black transition-all duration-300 group-hover:-translate-y-0.5 group-hover:bg-white/100 hover:shadow-md dark:bg-black/95 dark:text-white dark:hover:bg-black/100 dark:hover:shadow-neutral-800/50"
              >
...
export function HeroGeometricBackdropLayer() {
  return <HeroGeometricBackdrop />;
}
