...
export function BackgroundPathsLayer({ className }: { className?: string }) {
  return (
    <div className={cn('absolute inset-0 overflow-hidden bg-[#020617]', className)} aria-hidden="true">
      <div className="absolute inset-0 opacity-70">
        <FloatingPaths position={1} />
        <FloatingPaths position={-1} />
      </div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(99,102,241,0.2),transparent_40%),radial-gradient(circle_at_80%_80%,rgba(14,165,233,0.14),transparent_45%)]" />
    </div>
  );
}
