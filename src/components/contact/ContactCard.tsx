...
export function ContactCard({
  ...
  return (
    <article
      className={cn(
        'group rounded-2xl border border-white/10 bg-white/[0.025] p-6 shadow-[0_10px_28px_rgba(30,41,59,0.16)] backdrop-blur-md transition-all duration-300 hover:scale-[1.03] hover:border-indigo-400/55 hover:shadow-[0_18px_40px_rgba(99,102,241,0.16)] sm:p-7',
        className,
      )}
    >
